...
def create_app(test_config=None):
    ...
    def retrieve_questions():
        ...
        questions = Question.query.order_by(Question.id).limit(QUESTIONS_PER_PAGE).offset(offset).all()    
    ...
    def categorie_questions(category_id):
    ...
    def quizzes():
        ...
        try:
            ...
            if len(questions) == 0:
                ...
                random_id = random.choice(current_ids)
